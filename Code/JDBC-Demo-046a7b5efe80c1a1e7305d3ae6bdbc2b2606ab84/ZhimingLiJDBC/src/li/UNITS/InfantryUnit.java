...
public class InfantryUnit extends StormtrooperUnit{
	
	private HeavyWalkerUnit TransportedBy;

	public InfantryUnit(String STUID, BattleGroup UnitCmd, Units UnitType, int AssignedStrength, Location Position) {
